export default function LogoIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      ...
      <circle cx="20" cy="4" r="2" fill="var(--amber)" opacity="0.8"/>
      <line x1="20" y1="2" x2="20" y2="0" stroke="var(--amber)" strokeWidth="1" opacity="0.6"/>
      <line x1="16" y1="3" x2="14" y2="1" stroke="var(--amber)" strokeWidth="0.8" opacity="0.4"/>
      <line x1="24" y1="3" x2="26" y2="1" stroke="var(--amber)" strokeWidth="0.8" opacity="0.4"/>
    </svg>
  )
}
